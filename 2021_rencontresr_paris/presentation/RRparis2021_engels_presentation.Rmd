...
**Accompagner** des étudiants afin qu'ils soient capables de réaliser les étapes suivantes de manière **reproducutible** : 
...
\vfill
 ...
 => En 2020-2021, plus de **450.000 entrées** pour 130 étudiants dans notre base de données
...
read("data/sdd_log.csv") %>.%
  ...
  geom_boxplot() +
  coord_flip() +
  labs(y = "Somme des lignes modifiées", x = "Projets")
```
