...
**Évaluation continue** : une interrogation par module et tous les exercices en ligne et les projets sont également comptabilisés :

\vfill

* **Niveau 1** : exercices H5P et shiny =  \alert{2\%}
* **Niveau 2** : tutoriels avec learnr = \alert{4\%}
* **Niveau 3** : projets individuels cadrés = \alert{6\%}
* **Niveau 4** : projets de groupe = \alert{28\%}
* **Évaluations sommatives / challenges** : \alert{12\% x 5 modules}
...
-   Faible niveau en **littératie** (textes, mais aussi mathématique et numérique) de certains étudiants. *Rien pour leur faire prendre conscience, rien pour les aider ensuite* + faible niveau par rapport à la taxonomie de Bloom

-   **Notation** : les exercices donnent des points (reconnaissance du travail), les étudiants trichent, certains réussissent avec un niveau trop faible. **Note absorbante mal perçue** et points négatifs.

-   **Perception de la notation par les étudiants** : points "négatifs" mal perçus + impression d'être fliqué + réticence des étudiants face à une autre pédagogie

-   **Mauvaise perception de l'évaluation continue par les collègues** : séances obligatoires et pas d'examen en seconde session

-   **Examen en seconde session ou pas ?** Cf. évaluation continue. *Si pas pousse les étudiants à travailler pendant l'année, mais incompréhension.*

-   **Inutilisé constatée du redoublement** *(impossible de varier les exercices chaque année)*

-   **Temps nécessaire** *(préparation des exercices, corrections)* Souhait de passer à l'évaluation Moodle + Safe Exam Browser
